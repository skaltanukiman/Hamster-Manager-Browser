...
const messages: Record<string, string> = {
  ...
  joined: "共有に参加しました。",
  householdLeft: "Householdから退出し、利用するHouseholdを切り替えました。",
  ownershipTransferredAndLeft: "所有権を移譲してHouseholdから退出しました。",
  ...
  cannotLeaveSoleMember: "このHouseholdにはほかのメンバーがいないため、この画面からは退出できません。",
  ownershipTransferRequired: "現在は唯一のオーナーです。新しいオーナーを選択して、もう一度お試しください。",
  invalidTransferTarget: "自分自身を新しいオーナーには選択できません。",
  transferTargetUnavailable: "選択したメンバーは現在このHouseholdに所属していません。最新状態を再読み込みしてください。",
  householdAlreadyLeft: "このHouseholdからは既に退出しています。最新状態を再読み込みしてください。",
  householdLeaveStateChanged: "メンバーまたはオーナーの構成が変わりました。最新状態を再読み込みしてから、もう一度お試しください。",
